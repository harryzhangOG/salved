...
from dmbrl.values import DeepValueFunction, LyapunovValueFunction
...
def main(env, ctrl_type, ctrl_args, overrides, logdir, mode):
    ...
    if cfg.exp_cfg.exp_cfg.use_value:
        cfg.exp_cfg.exp_cfg.value = LyapunovValueFunction("value", cfg.val_cfg)
        cfg.exp_cfg.exp_cfg.value_target = LyapunovValueFunction("target", cfg.val_cfg)
